...
namespace Lara.Data.Migrations
{
    ...
    [Migration("20240331180428_BorrowedCanHaveManyBooks")]
    partial class BorrowedCanHaveManyBooks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lara.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Lara.Domain.Entities.BorrowedBook", b =>
                {
                    ...
                    b.HasOne("Lara.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Lara.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
